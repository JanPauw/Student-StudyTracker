<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Record_Hours.aspx.cs" Inherits="prjPOE_ASP_Framework.Record_Hours" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div style="margin: 15vh auto; width: 30%; text-align: center;">
        <h1 style="color: #084E62;">Record Hours</h1>
        <div style="width: 80%; margin-left: 10%; margin-right: 10%">
            <asp:Table ID="tblSemLength" runat="server" Width="100%">
                <asp:TableRow>
                    <asp:TableHeaderCell CssClass="aspHeadCell" ColumnSpan="2">Select Module:</asp:TableHeaderCell>
                </asp:TableRow>
                <asp:TableRow>
                    <asp:TableCell ColumnSpan="2">
                        <div>
                            <asp:DropDownList CssClass="aspTextBox" ID="dropModules" runat="server" Width="100%"></asp:DropDownList>
                        </div>
                    </asp:TableCell>
                </asp:TableRow>
                <asp:TableRow>
                    <asp:TableHeaderCell CssClass="aspHeadCell" ColumnSpan="2">Hours Studied:</asp:TableHeaderCell>
                </asp:TableRow>
                <asp:TableRow>
                    <asp:TableCell ColumnSpan="2">
                        <div>
                            <asp:TextBox CssClass="aspTextBox" ID="edtHours" runat="server" Width="100%"></asp:TextBox>
                        </div>
                    </asp:TableCell>
                </asp:TableRow>
                <asp:TableRow>
                    <asp:TableHeaderCell CssClass="aspHeadCell" ColumnSpan="2">Date Studied:</asp:TableHeaderCell>
                </asp:TableRow>
                <asp:TableRow>
                    <asp:TableCell ColumnSpan="2">
                        <div style="width: 100%;">
